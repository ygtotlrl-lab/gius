...
const APP = {
  ...
  migrations: {
    '000_init.sql': 'gius_init_schema',
    '001_revoke_delete.sql': 'gius_revoke_delete_truncate',
    '002_pass_fp.sql': null,
    '003_backup_log.sql': 'gius_0004_backup_log_verbatim_fix',
    '004_backup_retention_cron.sql': 'gius_0005_backup_retention_cron',
    '005_full_indexes.sql': 'gius_0006_full_indexes',
    '006_users_drop_plaintext_password.sql': 'gius_0007_users_drop_plaintext_password',
    '007_backup_retention_cap.sql': null,
    '008_soft_delete_columns.sql': 'soft_delete_columns_gius',
    '009_drop_g_users_password.sql': 'drop_g_users_password',
    '010_backup_anchor_diff_retention.sql': 'backup_anchor_diff_retention',
    '011_grant_retention_keys_anon.sql': '012_grant_retention_keys_anon',
    '012_stamp_bigint_drop_touch.sql': 'g_013_stamp_bigint_drop_touch',
    '013_users_client_id_shape.sql': 'g_014_users_client_id_shape',
    '014_client_id_is_the_key.sql': 'g_015_client_id_is_the_key',
    '015_config_shape_and_targets_soft_delete.sql': 'g_016_config_shape_and_targets_soft_delete',
    '016_role_vocabulary_admin.sql': 'g_role_vocabulary_admin',
    '017_role_vocabulary_check.sql': 'g_role_vocabulary_check',
    '018_role_junior.sql': 'role_junior_g_users',
    '019_g_config_value_json_check.sql': 'g_config_value_json_check',
    '020_bk_fn_def.sql': 'bk_fn_def',
    '021_rename_shared_tables_to_sh.sql': 'rename_shared_tables_to_sh',
    '022_drop_stale_sweep_overload.sql': 'drop_stale_bk_retention_sweep_overload',
    '023_backup_allowlist_kp.sql': 'backup_allowlist_kp',
  ...
  migNoRecord: {
    '002_pass_fp.sql': 'עמודות הטביעה נוספו מעורך ה-SQL בלי רישום — ⛔ ואין רשומה שתוכנה זה',
    '007_backup_retention_cap.sql': 'תקרת העותקים רצה מעורך ה-SQL בלי רישום — ⛔ ואין רשומה שתוכנה זה',
  },
