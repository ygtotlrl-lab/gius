...
const APP = {
  ...
  gapRows: [41, 73, 116, 118, 122, 144, 153, 59, 131],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    164: (c) => c.hasCode(/G_PASS_ITER\s*=\s*100000\b/)
...
const FLOOR = { shared: 81, app: 10, appWhy: 'כניסה — סשן · נעילה · הרשאות · כתיבת משתמש · שכבת המראה; ומעליהם שני בלוקי גרף העמודות' };
/* ⚠️ סוף פר-אפליקציה */
