...
const APP = {
  ...
  bpNoRule: {
    ...
    480: 'הטלפון הרחב מציג את אותה עמודה יחידה — ⚠️ והפרישה לשתי עמודות היא בנקודה שמעל: ⭐ ואין כאן מה להשתנות',
  },
  ...
  keystoreSha: 'd196aaf7c4875e63',
  schemaFile: 'migrations/000_init.sql',
   ...
   *  השורה: `id` לרוב הטבלאות, ⛔ `key` ל-`g_settings` ו-`month` ל-`g_targets`. */
  ...
  gapRows: [227, 80, 142, 144, 148, 172, 183, 66, 157, 100],
  ...
  rowsLayerFns: {},
  fullPullAllow: {},
  /*  ⛔ אין כאן רשומה שנושאת מערך פריטים — ⚠️ `g_settings` היא טבלת
  ...
  migrateKeep: {},
  mirrorTables: ['g_donors', 'g_pledges', 'g_txns', 'g_tasks', 'g_targets', 'g_users', 'g_settings'],
