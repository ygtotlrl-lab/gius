...
const APP = {
  ...
  gapRows: [39, 72, 109, 111, 115, 136, 144, 57],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    152: (c) => c.hasCode(/G_PASS_ITER\s*=\s*100000\b/)
