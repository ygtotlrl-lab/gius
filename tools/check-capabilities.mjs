...
const APP = {
  ...
  gapRows: [45, 74, 120, 122, 126, 150, 159, 60, 135],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    170: (c) => c.hasCode(/G_PASS_ITER\s*=\s*100000\b/)
