...
const APP = {
  ...
  gapRows: [41, 74, 115, 117, 121, 143, 152, 59, 130],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    163: (c) => c.hasCode(/G_PASS_ITER\s*=\s*100000\b/)
...
const FLOOR = { shared: 165, app: 8, appWhy: 'כניסה — סשן · נעילה · הרשאות · כתיבת משתמש · שכבת המראה' };
/* ⚠️ סוף פר-אפליקציה */
