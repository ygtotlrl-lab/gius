...
const APP = {
  ...
  presenceOnly: {
    ...
    '161|שכבת כניסה מלאה':
      'המיקום הוא מפת הפעולות, ושם פעולה מחוץ למפה הוא מטפל מת — ' +
      'ולכן מחרוזת פעולה בכל מיקום היא מפתח במפה האחת',
  },
  ...
  inlineStyleAllow: {
    ...
    breakdownTable: 'רוחב פס החלק נגזר מהנתון בזמן ריצה — אותו חריג בדיוק, '
      + 'ומחלקה לכל אחוז הייתה מאה מחלקות',
  },
  inlineColorAllow: {},
