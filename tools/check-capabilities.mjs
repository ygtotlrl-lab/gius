...
const APP = {
  ...
  gapRows: [41, 74, 114, 116, 120, 142, 151, 59, 129],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    162: (c) => c.hasCode(/G_PASS_ITER\s*=\s*100000\b/)
...
const FLOOR = { shared: 163, app: 8, appWhy: 'כניסה — סשן · נעילה · הרשאות · כתיבת משתמש · שכבת המראה' };
/* ⚠️ סוף פר-אפליקציה */
