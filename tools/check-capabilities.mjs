...
const APP = {
  ...
  exportFns: [],
  gapRows: [67, 95, 97, 101, 117, 118, 122, 123, 126, 128, 132],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    136: (c) => c.hasCode(/G_PASS_ITER\s*=\s*100000\b/)
