...
const APP = {
  ...
  gapRows: [85, 87, 89, 105, 110, 115, 122, 136],
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    119: (c) => c.hasCode(/G_PASS_ITER\s*=\s*100000\b/)
