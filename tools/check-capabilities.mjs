...
const APP = {
  ...
  gapRows: [41, 74, 113, 115, 119, 141, 150, 59, 128],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    161: (c) => c.hasCode(/G_PASS_ITER\s*=\s*100000\b/)
  ...
  enterFields: ["cfg-add-' + c.key + '", 'txn-amount', 'txn-date', 'txn-agent',
                ...
                'tg-month', 'tg-amount', 'cfg-v'],
  enterExempt: [
    { field: 'lg-user', why: 'טופס `submit` מקורי — הדפדפן שולח אותו במקש' },
    { field: 'lg-pass', why: 'טופס `submit` מקורי — הדפדפן שולח אותו במקש' },
    { field: 'donor-q', why: 'חיפוש תורם — אין בשורה כפתור שמירה' },
    { field: 'pf-from', why: 'סינון התחייבויות — אין בכרטיס כפתור שמירה' },
    { field: 'pf-to', why: 'סינון התחייבויות — אין בכרטיס כפתור שמירה' },
    { field: 'חיפוש תורם לפי שם או טלפון', why: 'בורר התורם הוא היקף שקט — המקש אינו יוצא ממנו אל הטופס שמעליו' },
    { field: '.inp dp-n-name', why: 'בורר התורם הוא היקף שקט — כפתוריו אינם במפת הפעולות' },
    { field: '.inp dp-n-phone', why: 'בורר התורם הוא היקף שקט — כפתוריו אינם במפת הפעולות' },
  ],
  ksaveActs: ['cfg-add', 'txn-save', 'pledge-save', 'task-save', 'donor-save',
              'user-save', 'pass-save', 'my-pass-save', 'switch-confirm',
              'target-save', 'cfg-edit-save'],
  keydownExempt: [
...
const FLOOR = { shared: 155, app: 8, appWhy: 'כניסה — סשן · נעילה · הרשאות · כתיבת משתמש · שכבת המראה' };
/* ⚠️ סוף פר-אפליקציה */
