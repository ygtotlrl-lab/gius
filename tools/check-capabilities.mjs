...
const APP = {
  ...
  gapRows: [44, 73, 119, 121, 125, 148, 157, 59, 134],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    168: (c) => c.hasCode(/G_PASS_ITER\s*=\s*100000\b/)
