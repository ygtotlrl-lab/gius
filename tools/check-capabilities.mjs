...
const APP = {
  ...
  gapRows: [40, 73, 110, 112, 116, 137, 145, 58],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    155: (c) => c.hasCode(/G_PASS_ITER\s*=\s*100000\b/)
