...
const APP = {
  ...
  gapRows: [40, 73, 111, 113, 117, 138, 146, 58],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    156: (c) => c.hasCode(/G_PASS_ITER\s*=\s*100000\b/)
