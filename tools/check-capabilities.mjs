...
const APP = {
  ...
  exportFns: [],
  gapRows: [66, 92, 94, 98, 114, 117, 118, 121, 123, 127],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    131: (c) => c.hasCode(/G_PASS_ITER\s*=\s*100000\b/)
