...
const APP = {
  ...
  exportFns: [],
  gapRows: [67, 93, 95, 99, 115, 116, 120, 121, 124, 126, 130],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    134: (c) => c.hasCode(/G_PASS_ITER\s*=\s*100000\b/)
