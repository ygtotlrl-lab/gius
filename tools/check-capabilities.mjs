...
const APP = {
  ...
  gapRows: [88, 90, 93, 109, 112, 113, 116, 117, 121, 128, 131, 141],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    125: (c) => c.hasCode(/G_PASS_ITER\s*=\s*100000\b/)
