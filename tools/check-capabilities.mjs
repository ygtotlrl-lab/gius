...
const APP = {
  ...
  gapRows: [41, 74, 112, 114, 118, 140, 148, 59, 127],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    159: (c) => c.hasCode(/G_PASS_ITER\s*=\s*100000\b/)
...
const FLOOR = { shared: 153, app: 8, appWhy: 'כניסה — סשן · נעילה · הרשאות · כתיבת משתמש · שכבת המראה' };
/* ⚠️ סוף פר-אפליקציה */
