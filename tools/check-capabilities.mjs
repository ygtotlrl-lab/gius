...
const APP = {
  ...
  exportFns: [],
  gapRows: [66, 92, 94, 97, 113, 116, 117, 120, 121, 125],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    129: (c) => c.hasCode(/G_PASS_ITER\s*=\s*100000\b/)
