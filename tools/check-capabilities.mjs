...
const APP = {
  ...
  actMap: 'ACTIONS',
  gapRows: [38, 67, 102, 104, 108, 126, 127, 131, 141],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    145: (c) => c.hasCode(/G_PASS_ITER\s*=\s*100000\b/)
