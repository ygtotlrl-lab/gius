...
const APP = {
  ...
  gapRows: [86, 88, 91, 107, 109, 112, 113, 117, 124, 127, 137],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    121: (c) => c.hasCode(/G_PASS_ITER\s*=\s*100000\b/)
