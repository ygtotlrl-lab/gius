...
const APP = {
  ...
  exportFns: [],
  gapRows: [64, 90, 92, 95, 111, 114, 115, 118, 119, 123, 130, 133, 143],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    127: (c) => c.hasCode(/G_PASS_ITER\s*=\s*100000\b/)
