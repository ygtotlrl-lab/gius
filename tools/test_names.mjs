...
const APP = {
  ...
  namePolicy: {
    ...
    appTokens: {
      '--border-2': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--brand-fill': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--gold': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--gold-soft': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--tab-h': 'גובה סרגל הלשוניות — ⛔ ואין לאחיות אסימון גובה-סרגל כלל',
    },
