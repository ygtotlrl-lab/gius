...
const APP = {
  ...
  calendar: { kind: 'gregorian',
    why: 'יעד הגבייה הוא חודש לועזי — ⚠️ המתרים והתורם סוגרים תשלום לפי חודש בלוח שלהם, ⭐ ולא לפי ראש חודש' },
  ...
  coreVerbs: {
    monthKeyOf: { name: 'monthKeyOf',
      why: 'מפתח החודש של רשומה — ⚠️ וכאן הוא `YYYY-MM` של תאריך התנועה, ⭐ והיעד החודשי נזקף לפיו' },
    monthLabel: { name: 'monthLabel',
      why: 'תווית החודש לתצוגה — ⚠️ וכאן הקלט הוא מפתח `YYYY-MM` אחד, ⭐ והיא נגזרת ממנו בלוח הלועזי' },
    monthsWithData: { name: null,
      why: 'החודשים שיש בהם רשומות — ⛔ וכאן הרשימה נגזרת מהיעדים ומהתנועות באתר התצוגה עצמו: ⚠️ ואין רשימה שנבנית פעם אחת' },
    yearOf: { name: null,
      why: 'השנה של רשומה — ⛔ ואין כאן מושג של שנה: ⚠️ היעד חודשי, ⭐ וכל סיכום נגזר מחודשים' },
  },
};
/* ── סוף APP ───────────────────────────────────────────────────────────── */
