...
4. אחרי חתימה — לאמת שה-SHA256 תואם לטבלה למעלה. ה-workflow עושה זאת אוטומטית
   ונכשל על אי-התאמה.
5. **המפתח אינו בריפו.** ה-workflow קורא אותו מ-secret בשם `GIUS_KEYSTORE_B64`
   (ה-keystore ב-base64). בלי ה-secret הוא מעלה APK לא חתום.
