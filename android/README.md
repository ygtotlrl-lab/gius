...
| **versionCode** | 6 — קודם בסבב 46ב (היפוך ברירת המחדל בקובצי התצורה). 5 = סבב 45, 4 = סבב 41, 3 = סבב 40, 2 = המעטפת הראשונה של WebView. ⛔ versionCode לעולם אינו יורד — מספר נמוך ממה שמותקן במכשיר חוסם את העדכון |
