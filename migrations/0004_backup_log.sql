-- ============================================================================
-- 0004_backup_log.sql — גיבוי יומי ויומן פעולות (סבב 30, שלב א)
-- ============================================================================
...
--    ואומתה מול `information_schema` של הפרויקט המשותף בסבב 30). שם הטבלה,
...
--    סעיף 9, סבב 29): מי שאינו יכול לעדכן אינו יכול לזייף רישום קיים, ומי
...
-- ⛔ `g_users` נגבית בעמודות מפורשות ולא ב-`*` (סבב 30) — הטבלה הזו קריאה
...
-- ⛔ אותו דפוס ומאותה סיבה כמו ב-`sync_log` שלמעלה.
