-- ============================================================================
-- 020_g_config_value_json_check.sql — ערך במפתח-ערך הוא JSON
-- ============================================================================
--
-- ⛔ **רץ במסד.**
--
-- ⛔⛔ **מה הקובץ עושה:** ⚠️ מוסיף אילוץ `check` על עמודת `value` ב-`g_config` —
...
begin
  if not exists (
    ...
    where conname = 'g_config_value_json' and conrelid = 'public.g_config'::regclass
  ) then
    alter table public.g_config
      add constraint g_config_value_json
