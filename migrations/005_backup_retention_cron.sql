-- ============================================================================
-- 005_backup_retention_cron.sql — פינוי אוטומטי ל-kv_backup דרך pg_cron
-- ============================================================================
--
...
-- ───────────────────────────────────────────────────────────────────────────
-- ⛔⛔ **רשימת-היתר מפורשת ולא קידומת** — קידומת (`like 'g\_%'`,
...
-- ───────────────────────────────────────────────────────────────────────────
-- ⚠️ 03:00 UTC: הדגל היומי של הגיבוי הוא תאריך **UTC**, ולכן חצות UTC היא
--    הרגע שבו כל המכשירים מתחילים לגבות. הגריעה נוגעת ממילא רק בשורות בנות
--    30+ יום ולעולם לא בעותק שנכתב היום.
...
-- ⛔ `unschedule` לפני `schedule` — מה שהופך את הקובץ לאידמפוטנטי
